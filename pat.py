...
#Adding Buttons
b1=Button(win, text='Appointment Management',font=('Dubai',15),command=apn, bg='#BF8969')
...
b3=Button(win, text='Patient Details',font=('Dubai',15), bg='#BF8969')
...
#Buttons
b1=Button(win, text='Add',font=('Dubai',13), command=add,
          bg='#BF8969')
c.create_window(310, 30, window=b1)

b2=Button(win, text='Update',font=('Dubai',13), command=update,
          bg='#BF8969')
c.create_window(380, 30, window=b2)

b3=Button(win, text='Delete',font=('Dubai',13),command=delete,
          bg='#BF8969')
...
for i in range(0, len(ls.index)):
   ...
   for j in range(0, len(ls.columns)):
        ...
        usr.config(disabledbackground='#A65E44',
...
c.create_text(700,80, text = 'D.O.B', font=("Dubai",19))
c.create_text(870,80, text = 'Contact No.', font=("Dubai",19))
c.create_text(1040,80, text = 'Age', font=("Dubai",19))
c.create_text(1210,80, text = 'Doctor', font=("Dubai",19))
